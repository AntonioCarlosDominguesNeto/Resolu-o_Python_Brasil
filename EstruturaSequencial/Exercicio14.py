'''
Exercicio 14: João Papo-de-Pescador, homem de bem, comprou um microcomputador para controlar o rendimento
...
print("Peso dos peixes:", peso,"KGs")
print("Excesso de:", excesso,"KGs")
print("Valor da multa a ser paga: R$",multa)